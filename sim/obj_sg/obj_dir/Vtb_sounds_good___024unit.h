...
#ifndef VERILATED_VTB_SOUNDS_GOOD___024UNIT_H_
#define VERILATED_VTB_SOUNDS_GOOD___024UNIT_H_  // guard

#include "verilated.h"
#include "Vtb_sounds_good___024unit.h"


class Vtb_sounds_good__Syms;
struct Vtb_sounds_good_s_clks__struct__0 {
    ...
    bool operator==(const Vtb_sounds_good_s_clks__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<Vtb_sounds_good_s_clks__struct__0> : public std::true_type {};
struct Vtb_sounds_good_s_irdecod__struct__0 {
    ...
    bool operator==(const Vtb_sounds_good_s_irdecod__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<Vtb_sounds_good_s_irdecod__struct__0> : public std::true_type {};
struct Vtb_sounds_good_s_nanod__struct__0 {
    ...
    bool operator==(const Vtb_sounds_good_s_nanod__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<Vtb_sounds_good_s_nanod__struct__0> : public std::true_type {};

class alignas(VL_CACHE_LINE_BYTES) Vtb_sounds_good___024unit final {
  public:

    // INTERNAL VARIABLES
    Vtb_sounds_good__Syms* vlSymsp;
    const char* vlNamep;

    // CONSTRUCTORS
    Vtb_sounds_good___024unit();
    ~Vtb_sounds_good___024unit();
    void ctor(Vtb_sounds_good__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_sounds_good___024unit);
