    ...
    , TOP{this, namep}
{
    ...
    __Vscopep_tb_system__video->varInsert("sprram", &(TOP.tb_system__DOT__video__DOT__sprram), false, VLVT_UINT16, VLVD_NODIR|VLVF_PUB_RD, 1, 1 ,0,4095 ,15,0);
    __Vscopep_tb_system__video->varInsert("vram", &(TOP.tb_system__DOT__video__DOT__vram), false, VLVT_UINT16, VLVD_NODIR|VLVF_PUB_RD, 1, 1 ,0,4095 ,15,0);
}
