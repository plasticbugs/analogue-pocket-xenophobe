...
#ifndef VERILATED_VTB_XENO___024UNIT_H_
#define VERILATED_VTB_XENO___024UNIT_H_  // guard
...
struct Vtb_xeno_s_clks__struct__0 {
    ...
    bool operator==(const Vtb_xeno_s_clks__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<Vtb_xeno_s_clks__struct__0> : public std::true_type {};
struct Vtb_xeno_s_irdecod__struct__0 {
    ...
    bool operator==(const Vtb_xeno_s_irdecod__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<Vtb_xeno_s_irdecod__struct__0> : public std::true_type {};
struct Vtb_xeno_s_nanod__struct__0 {
    ...
    bool operator==(const Vtb_xeno_s_nanod__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<Vtb_xeno_s_nanod__struct__0> : public std::true_type {};

class alignas(VL_CACHE_LINE_BYTES) Vtb_xeno___024unit final {
  public:
    ...
    Vtb_xeno___024unit();
    ~Vtb_xeno___024unit();
    void ctor(Vtb_xeno__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_xeno___024unit);
